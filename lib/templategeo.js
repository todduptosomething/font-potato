...
//
// 0.24 is not arbitrary: measured against a real filled sheet, capitals
// landed at 0.247 unprompted, so the line sits where the hand already goes
// and leaves headroom above for ascenders and swash flourishes. It also
// clears HINT_WORD (which ends at 0.20) so the symbol captions stay legible.
// The x-height line is 0.64 of the cap height above the baseline — generous,
// as informal and handwritten faces tend to run.
