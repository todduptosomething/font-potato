...
function buildTTFWithAlternates(name, glyphList, meta = {}) {
  ...
  const font = new opentype.Font({
    ...
    glyphs,
    manufacturer: 'Font Potato',
    designer: authorName || undefined,
    copyright: `Copyright © ${year} ${authorName || 'the font’s creator'}. All rights reserved.`,
    description: `Handwriting font generated by Font Potato${authorName ? ` from ${authorName}’s handwriting` : ''}.`,
    version: 'Version 1.0',
  });
